...
\begin{body}
	\vspace{15pt}
	\textbf{Apple}, \emph{Platform Architecture - Graphics Intern} \hfill \emph{June 2014 - Present}\\
	\vspace*{-5pt}
	\begin{itemize} \itemsep -0pt %reduce space between items
	\item Details are currently secret, but working on optimizing the software graphics performance of various Apple products.
	\end{itemize}
	\vspace*{-3pt}
