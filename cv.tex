...
\begin{body}
	...
	\item Exploring Cognitive Neuroscience from the perspective of Computer Science by carefully analyzing fMRI data using standard statistical and Machine Learning techniques.
	\item Working with Professor Akama to design language tasks, run the fMRI experiments, and subsequently analyze the data.
	\end{itemize}
	\vspace*{1pt}
...
\begin{body}
	\vspace{18pt}
	\textbf{Simultaneously finding the neural basis of semantic representation and language switching with an fMRI langauge study}, \emph{TiROP Program Research at Tokyo Tech} \hfill \emph{Jun. 2015 - Present} \\
		\vspace*{-3pt}
	\begin{itemize} \itemsep -0pt
